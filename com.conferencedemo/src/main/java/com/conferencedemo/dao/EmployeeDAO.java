 ...
 * 
 * import com.conferencedemo.model.Employee; import
 * org.springframework.stereotype.Repository;
 * 
 * @Repository public class EmployeeDAO {
 * 
 * private static final Map<String, Employee> empMap = new HashMap<String,
 * Employee>();
 * 
 * 
 * static { initEmps(); }
 ...
 * 
 * public EmployeeDAO() { empMap = new EmployeeRepository(); } 
 * EmployeeRepository();
 * 
